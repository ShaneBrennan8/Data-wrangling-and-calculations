...
A_C2 = read.csv("manual_data_minus_dump_202103251231.csv", head=TRUE, sep=",")
...
A_C2 = read.csv("auto_data_minus_dump_202103252212.csv", head=TRUE, sep=",")
...
A_C = read.csv("combined_combined_minus_dump_202103151235 - HSI + TEL.csv", head=TRUE, sep=",")
...
############### FP SUM ###############
#At this point you want to be merging datasets together
...
######## TP Addition #######
# Here we'll take the remainders from our processes about
